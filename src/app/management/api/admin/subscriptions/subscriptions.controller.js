...
class SubscriptionsController {
  ...
  revoke(subscription, apiKey) {
    ...
    this.$mdDialog.show({
      ...
      controllerAs: 'ctrl',
      templateUrl: 'app/managementcomponents/dialog/confirmWarning.dialog.html',
  ...
  showExpirationModal(apiKey) {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/management/api/admin/subscriptions/apikey.expiration.dialog.html',
      clickOutsideToClose: true
  ...
  process(subscription, accepted) {
    ...
    if (accepted) {
      this.$mdDialog.show({
        ...
        templateUrl: 'app/management/api/admin/subscriptions/subscription.accept.dialog.html',
        clickOutsideToClose: true
      ...
      this.$mdDialog.show({
        ...
        templateUrl: 'app/management/api/admin/subscriptions/subscription.reject.dialog.html',
        clickOutsideToClose: true
  ...
  showAddSubscriptionModal() {
    ...
    this.ApiService.getPublishedApiPlans(this.api.id).then( (response) => {
      ...
      _this.$mdDialog.show({
        ...
        templateUrl: 'app/management/api/admin/subscriptions/subscription.create.dialog.html',
        plans: plans,
        clickOutsideToClose: true
      }).then( (data) => {
