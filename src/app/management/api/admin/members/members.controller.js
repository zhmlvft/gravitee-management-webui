...
class ApiMembersController {
  ...
  showAddMemberModal(ev) {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/management/api/admin/members/addMember.dialog.html',
  ...
  showPermissionsInformation() {
    this.$mdDialog.show({
      ...
      controllerAs: 'ctrl',
      templateUrl: 'app/management/api/admin/members/permissions.dialog.html',
      parent: angular.element(document.body),
      clickOutsideToClose:true
    });
  }
    ...
    this.$mdDialog.show({
      ...
      controllerAs: 'ctrl',
      templateUrl: 'app/managementcomponents/dialog/confirm.dialog.html',
      clickOutsideToClose: true,
  ...
  showTransferOwnershipConfirm(ev) {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/management/api/admin/members/transferAPI.dialog.html',
      parent: angular.element(document.body),
      targetEvent: ev,
      clickOutsideToClose:true
