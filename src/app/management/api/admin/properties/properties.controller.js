...
class ApiPropertiesController {
  ...
  showPropertyModal() {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/management/api/admin/properties/add-property.dialog.html',
      clickOutsideToClose: true
  ...
  showExpectedProviderOutput() {
    this.$mdDialog.show({
      ...
      controllerAs: 'ctrl',
      templateUrl: 'app/management/api/admin/properties/dynamic-provider-http.dialog.html',
