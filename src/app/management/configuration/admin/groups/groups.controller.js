...
class GroupsController {
  ...
  showAddGroupModal() {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/managementconfiguration/admin/groups/dialog/add-group.dialog.html',
      currentName: "",
      action: "Add",
  ...
  showAddMemberModal(ev) {
    ...
    this.$mdDialog.show({
      ...
      templateUrl: 'app/managementconfiguration/admin/groups/dialog/addMember.dialog.html',
